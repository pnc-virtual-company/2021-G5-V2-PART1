<template>
    <section>
        <div class="mb-3 mt-3">
            <input type="text" placeholder="Enter title..." class="form-control" v-model="form.title"/>
        </div>
        <div class="mb-3 mt-3">
            <select id="categories" name="categories" class="form-control" v-model="form.categories">
        ...
        <div class="dateTime mb-3 mt-3">
            <input type="date" placeholder="Start date..." class="form-control" v-model="form.start_date"/>
            <input type="time" placeholder="At..." class="form-control" v-model="form.start_at"/>
        </div>
        <div class="dateTime" mb-3 mt-3>
            <input type="date" placeholder="End date..." class="form-control" v-model="form.end_date"/>
            <input type="time" placeholder="At..." class="form-control" v-model="form.end_at"/>
        </div>
        <div class="mb-3 mt-3">
            <input type="text" placeholder="link join..." class="form-control" v-model="form.link_join"/>
        </div>
        <div class="mb-3 mt-3">
            <select id="country" name="country" class="form-control" v-model="form.city">
        ...
        <div class="mb-3 mt-3">
            <input type="text" placeholder="Description..." class="form-control" v-model="form.body"/>
        </div>
        <div class="modal-footer" >
            <button type="button" class="btn btn-outline-danger" data-bs-dismiss="modal" @click.prevent="clearForm">Cancel</button>
            <button type="submit" class="btn btn-outline-primary" data-bs-dismiss="modal" @click.prevent="handleDataInput()">Submit</button>
        </div>
    </section>
</template>
...
export default {
    ...
    methods: {
        ...
        getEvent(){
            // if(this.action === 'edit'){
                // console.log(this.event)
                // let eventSeleted = this.event
                // this.title = eventSeleted.title
                // this.categories_id = eventSeleted.categories_id
