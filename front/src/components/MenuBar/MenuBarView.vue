            ...
            <ul>
              ...
              <li>
                <router-link to="/events"
                  ><i class="fa fa-calendar" aria-hidden="true"></i> My Event
                </router-link>
              </li>
              <li>
...
<script>
import evenView from '../Event-Page/MyEventView.vue'
export default {
  components:{
    'my-event':evenView
  },
...
.button-add button {
  ...
  font-size: 13px;
  cursor: pointer;
  box-shadow: rgba(93, 87, 50, 0.25) 0px 50px 100px -20px,
    rgba(0, 0, 0, 0.3) 0px 30px 60px -30px;
  color: #c5ced8;
  border-radius: 0px 15px 0px 15px;
  border-bottom: 2px solid #f96233;
  border-top: 2px solid #f96233;
}
.button-event {
  background: #004f6c;
  border: none;
